    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <Badge className="bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 px-4 py-2 text-sm font-medium mb-4">
            🛠 Tech Stack
          </Badge>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Carefully selected technologies optimized for ROOT blockchain applications and Web3 user experiences
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800 hover:shadow-lg transition-shadow duration-200">
            <CardHeader>
              ...
              <CardDescription className="text-blue-700 dark:text-blue-300">
                Modern React framework with optimized deployment for ROOT network dApps
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800 hover:shadow-lg transition-shadow duration-200">
            <CardHeader>
              ...
              <CardTitle className="text-purple-900 dark:text-purple-100">ROOT Network</CardTitle>
              <CardDescription className="text-purple-700 dark:text-purple-300">
                Native ROOT blockchain integration with smart contract support
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-2">
                <li>• ROOT network RPC connections</li>
                <li>• Smart contract interactions</li>
                <li>• Futurepass wallet integration</li>
                <li>• Native token operations</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">ROOT Network Starter Template</h3>
                  <p className="text-muted-foreground">
                    Complete example implementation with ROOT network integration, smart contracts, and production deployment
                  </p>
                </div>
              </div>
              <Button 
