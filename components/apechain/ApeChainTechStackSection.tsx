...
export function ApeChainTechStackSection() {
  return (
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 max-w-6xl">
        {/* Section Header */}
        <div className="text-center mb-16">
          <Badge className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white border-0 px-4 py-2 text-sm font-medium mb-4">
            🛠 Tech Stack
          </Badge>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Carefully selected technologies optimized for ApeChain applications with APE token integration and gaming-focused features
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800 hover:shadow-lg transition-shadow duration-200">
            <CardHeader>
              ...
              <CardDescription className="text-blue-700 dark:text-blue-300">
                Modern React framework with optimized deployment for ApeChain network dApps
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-2">
                ...
                <li>• Optimized for NFT interactions</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border-orange-200 dark:border-orange-800 hover:shadow-lg transition-shadow duration-200">
            <CardHeader>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center">
                  <Wallet className="h-5 w-5 text-white" />
                </div>
                <Badge className="bg-orange-500 text-white text-xs">Web3</Badge>
              </div>
              <CardTitle className="text-orange-900 dark:text-orange-100">ApeChain Network</CardTitle>
              <CardDescription className="text-orange-700 dark:text-orange-300">
                Native ApeChain integration with APE token support and NFT marketplace features
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="text-sm text-orange-700 dark:text-orange-300 space-y-2">
                <li>• APE token integration</li>
                <li>• NFT marketplace protocols</li>
                <li>• Gaming-optimized contracts</li>
                <li>• BAYC ecosystem tools</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">ApeChain Network Starter Template</h3>
                  <p className="text-muted-foreground">
                    Complete example implementation with ApeChain integration, APE token operations, NFT marketplace features, and production deployment
                  </p>
                </div>
              </div>
              <Button 
