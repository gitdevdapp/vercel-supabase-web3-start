...
Merge homepage and Supabase functionality from [vercel-supabase-web3-start](https://github.com/gitdevdapp/vercel-supabase-web3-start) repository with the CDP functionality of this repository, enabling logged-in Supabase administrators to globally archive wallets and control the archiving process.
