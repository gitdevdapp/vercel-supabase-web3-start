...
2. **Revoke Compromised API Key**:
   ...
   - Find API Key ID: `[REDACTED-CDP-API-KEY-ID]`
...
bfg --replace-text <(echo '[REDACTED-CDP-API-KEY-ID]==[REDACTED]') [your-repo].git
bfg --replace-text <(echo '[REDACTED-CDP-API-KEY-SECRET]==[REDACTED]') [your-repo].git
...
[REDACTED-CDP-API-KEY-ID]==[REDACTED]
[REDACTED-CDP-API-KEY-SECRET]==[REDACTED]
[REDACTED-CDP-WALLET-SECRET]==[REDACTED]
EOF
